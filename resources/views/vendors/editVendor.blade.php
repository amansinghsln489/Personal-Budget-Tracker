    ...
    <div class="content container-fluid">
        <div class="page-header">
            ...
            <div class="col-sm-12 col-12 text-left add-btn-col">
                <a href="{{ route('view.lead') }}" class="btn btn-primary float-right btn-rounded"><i class="fas fa-plus"></i> View All Vendors </a>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="email" class="form-control" name="alternate_email" placeholder="Alternate Email" value="{{ $vendor->alternate_email }}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="fas fa-envelope"></i>
                                                    </span>
