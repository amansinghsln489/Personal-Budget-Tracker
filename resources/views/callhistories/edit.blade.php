...
@section('content')
@section('title', 'Edit Call History Entry')
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <h5 class="text-uppercase mb-0 mt-0 page-title">Edit Call History Entry</h5>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <ul class="breadcrumb float-right p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><span>Edit Entry</span></li>
                    </ul>
                </div>
            </div>
            
            <div class="col-sm-12 col-12 text-left add-btn-col">
                <a href="{{ route('callhistory.index') }}" class="btn btn-primary float-right btn-rounded"><i class="fas fa-list"></i> View All Call History </a>
            </div>
        </div>
            ...
            <div class="col-lg-6 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <form class="m-b-30" method="POST" action="{{ route('callhistory.update', $callHistory->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="mobile_no" placeholder="Mobile Number" value="{{ old('mobile_no', $callHistory->mobile_no) }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="technology_id">
                                            ...
                                            @foreach($technologies as $technology)
                                                <option value="{{ $technology->technology_id }}" {{ old('technology_id', $callHistory->technology_id) == $technology->technology_id ? 'selected' : '' }}>{{ $technology->technology_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" name="comment" rows="3" placeholder="Comment">{{ old('comment', $callHistory->comment) }}</textarea>
                                            <div class="input-group-append">
                                                <span class="input-group-text">
