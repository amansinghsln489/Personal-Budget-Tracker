                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control" rows="2" readonly data-toggle="popover" title="Call History Comments" data-content="{{ $callHistory->comment }}" style="width: 100%;">{{ $callHistory->comment }}</textarea>
                                        </td>

                                      <td>{{ $callHistory->created_by }}</td>
                                      <td>{{ $callHistory->created_at->format('d-m-Y H:i') }}</td>
