                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('profiles.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="profile_name" id="profile_name" value="{{ $profile->profile_name }}">
                                <div id="profile_name_error" class="error" style="color: red; font-weight: bold;"></div>
                            </div>

                            <div class="form-group">
                                <label>Ring Central Number</label>
                                <input type="text" class="form-control" name="ring_central_number" id="ring_central_number" value="{{ $profile->ring_central_number }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="comment" id="comment" rows="3">{{ $profile->comment }}</textarea>
                            ...
                            <div class="card-body">
                                <div id="variant-section">
                                    ...
                                    <div class="row mt-12">
                                        <input type="hidden" name="email_pass_id[]" value="{{ $emailPass->id }}">
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <label>Email ID <i class="fas fa-envelope"></i></label>
                                                <input type="email" class="form-control"  name="email_id[]" value="{{ $emailPass->email_id }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <label>Password for Email <i class="fas fa-lock"></i></label>
                                                <input type="text" class="form-control" name="email_password[]" value="{{ $emailPass->email_password }}">
                                            </div>
                                        </div>
                            ...
                            <div class="form-group text-center custom-mt-form-group">
                                <button class="btn btn-primary mr-2" type="submit" name="submit">Update Profile</button>
